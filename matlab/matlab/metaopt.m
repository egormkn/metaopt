function varargout=metaopt(name, varargin)
% default function call to call the metaopt lib
    ...
    try
        ...
        syscall = ['LD_LIBRARY_PATH="" && ' metaopt_path '../bin/metaopt ' metaopt_path infile ' ' metaopt_path outfile ' ' name ' ' num2str(outargs)]
