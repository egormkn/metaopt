...
SRC_METAOPT_SCIP_CONSTRAINTS=SteadyStateConstraint.cpp RelaxedNaiveThermoConstraint.cpp ThermoConstraintHandler.cpp PotBoundPropagation.cpp  PotBoundPropagation2.cpp
