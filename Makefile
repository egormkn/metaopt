...
SRC_METAOPT_MODEL_SCIP=ScipModel.cpp LPFlux.cpp ModelAddOn.cpp
SRC_METAOPT_MODEL_SCIP_DIR=scip
SRC_METAOPT_MODEL_SCIP_ADDON=PotentialDifferences.cpp
SRC_METAOPT_MODEL_SCIP_ADDON_DIR=addon
SRC_METAOPT_SCIP=
SRC_METAOPT_SCIP_DIR=scip
SRC_METAOPT_SCIP_CONSTRAINTS=SteadyStateConstraint.cpp WeakNaiveThermoConstraint.cpp
