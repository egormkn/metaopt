...
SRC_METAOPT_MODEL_SCIP=ScipModel.cpp LPFlux.cpp ModelAddOn.cpp Solution.cpp LPPotentials.cpp DualPotentials.cpp ReducedScipFluxModel.cpp AbstractScipFluxModel.cpp
