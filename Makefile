...
SRC_METAOPT_MODEL=Model.cpp Metabolite.cpp Reaction.cpp ReversedReaction.cpp
...
SRC_METAOPT_SCIP_CONSTRAINTS=SteadyStateConstraint.cpp RelaxedNaiveThermoConstraint.cpp ThermoConstraintHandler.cpp PotBoundPropagation.cpp
